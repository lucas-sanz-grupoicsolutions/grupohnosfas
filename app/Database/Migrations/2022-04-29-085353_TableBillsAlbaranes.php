...
class TableBillsAlbaranes extends Migration
{
    public function up()
    {
        ...
        $this->forge->addKey('id_b_a', true);
		//$this->forge->addForeignKey('id_group', 'groups', 'id_group', 'CASCADE', 'CASCADE');
		$this->forge->createTable('tableBillsAlbaranes');
	}

    public function down()
    {
        $this->forge->dropTable('tableBillsAlbaranes');
    }
}
