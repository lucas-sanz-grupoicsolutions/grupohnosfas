...
class TableBillsAlbaranesModel extends Model
{
    protected $DBGroup = 'default';
    protected $table = 'tablebillsalbaranes';
    protected $primaryKey = 'id_b_a';
    protected $useAutoIncrement = true;
    protected $insertID = 0;
    protected $returnType = TableBillsAlbaranes::class;
